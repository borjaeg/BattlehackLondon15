...
cursor.execute(query)
query="INSERT INTO challenges(name, description, donators, levying, proof, charrllenger_name,challenger_photo) VALUES ('Hack-Ups for Africa', 'Are you tired of coding in Haskell all night? No, you`re not! You still have some energy in you to squeeze. Join me in doing some pushups and give all you got for the charity. All the raised money will be given to the Red Cross', 63, 213, 'http://embed.bambuser.com/broadcast/5462014', 'Borja Espejo', 'https://pbs.twimg.com/profile_images/572892628094423040/sja06mu9_400x400.jpeg');"
cursor.execute(query)
